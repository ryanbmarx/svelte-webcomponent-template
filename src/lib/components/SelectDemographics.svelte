<script lang="ts">
	...
	const INCOMES: RadioItem[] = [
		...
		{
			label: 'Moderate income: $32,000 to $64,000.',
			value: 2,
		},
		{ label: 'Middle income and above: More than $64,000', value: 3 },
	] as const;
</script>

<section class="bg-container">
	<h3 class="future-ed-header h1" style:grid-column="1" data-counter="2">Select demographics</h3>
	<div>
